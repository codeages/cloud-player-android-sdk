...
public class DocumentActivity extends BaseMediaActivity {
    ...
    public void initView() {
        super.initView();
        mControlView.setMediaType(ResourceType.DOCUMENT);
        mLlVideoControlLayout.setVisibility(View.GONE);
    }

    @Override
    public void onLoadMedia() {
        Map<String, String> params = getMediaParams("document.json");
