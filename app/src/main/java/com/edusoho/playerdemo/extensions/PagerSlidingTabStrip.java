...
package com.edusoho.playerdemo.extensions;
...
public class PagerSlidingTabStrip extends HorizontalScrollView {
     ...
     * 业务需要，点中tab跳转，不滑动
     */
    private int isFreezePosition = -1;
    ...
    public void setFreezePosition(int isFreezePosition) {
        this.isFreezePosition = isFreezePosition;
    }
